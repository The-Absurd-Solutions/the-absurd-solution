        ...
        <div className="flex flex-col gap-32">
            {projects.map((project, index) => (
                <motion.div
                    ...
                    className={`flex flex-col md:flex-row gap-12 md:gap-24 items-center group cursor-pointer ${
        ...
        {selectedProject && (
            ...
            >
                ...
                >
                    <button 
                        onClick={() => setSelectedProject(null)}
                        className="absolute top-6 right-6 z-50 p-2 bg-black text-white hover:bg-gray-800 transition-colors rounded-full"
                    >
                        <X size={24} />
                    </button>
